...
def main(input_filepath, output_filepath):
    ...
    df = df[
        ["Pregnancies", "Glucose", "BP", "skin_thickness", "insulin", "BMI", "diabetespdegreefunction", "age", "class"]
    ]

    df = df.dropna()
    inputs = df[["Pregnancies", "Glucose", "BP", "skin_thickness", "insulin", "BMI", "age"]]

    outputs = df[["diabetespdegreefunction", "class"]]
